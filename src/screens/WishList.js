...
import CarIcon from '../assets/images/green.png';
import { getWishListData } from '../services/restclient/RestApi';
const WishList = ({ navigation }) => {
  ...
  const getData = async () => {
    await getWishListData()
      .then((res) => {
        ...
        console.log('abcd', result.data[0]['BlockA']);
  ...
  const handleMeA = (val) => {
    ...
    setarr(dummy);
    setRefresh(!refresh);
    navigation.navigate('WishListTime', {
      val: val,
      Block: 'A',
    });
  };
